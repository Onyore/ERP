              ...
              <form action="insert_update.php" method="post">
				...
				<div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-user" name="certNo"  required">
                  </div>
                </div>
				...
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    Congregation No:
                    <input type="text" class="form-control form-control-user" name="CongreNo"  placeholder="7th, 6th, 5th, 4th" required>
                  </div>
				 ...
				 <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-user" name="GradNo" value="409" required>
                  </div>
				  </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
