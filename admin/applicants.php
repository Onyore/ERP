...
?>
          ...
          <button class="btn" onclick= "window.location.href= 'print/Pending/pdf.php'"><i class="fa fa-download"></i> Approved Finance</button>
		  <button class="btn" onclick= "window.location.href= 'print/First_level/pdf.php'"><i class="fa fa-download"></i> PENDING</button>
