...
function Header(){
      ...
      $this->Cell(265,12,'(Pending Approval Cash Office)',0,0,'C');
	  $this->Ln(20);
		...
		$this->Cell(70,10,'Full Names',1,0,'',true);
		$this->Cell(117,10,'School',1,0,'',true);
		
		
		
		$this->Cell(55,10,'Level',1,1,'',true);
...
$query=mysqli_query($con,"SELECT * FROM Students where Received=1 AND not Library_Status=0 AND NOT Finance_Status=0 AND Cash_Status=0");
...
elseif($School==11){
	...
	$pdf->Cell(70,9,$data['FullName'],1,0);
	$pdf->Cell(117,9,$School,1,0);
