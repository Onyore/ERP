...
$sql="SELECT * FROM Students WHERE Received=0 AND Faculty=$School";
...
while($row=mysqli_fetch_array($result)){	
           ...
           echo"<tr><td>".$row['id']."</td><td>".$row['RegNo']."</td> <td>".$row['Programme']."</td><td>"
			...
			<td><a href='received.php? id=".$row['id']."';> Received</a></td>
			</tr>";
...
?>
          ...
          <button class="btn" onclick= "window.location.href= 'print/Received/pdf.php'"><i class="fa fa-download"></i> Download Received</button>
