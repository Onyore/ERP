...
function Header(){
      ...
      $this->Cell(265,12,'Library paid(Cash Office)',0,0,'C');
	  $this->Ln(20);
		...
		$this->Cell(117,10,'Programme',1,0,'',true);
...
$query=mysqli_query($con,"SELECT * FROM Students where Library_Paid=1");
