...
function Header(){
      ...
      $this->Cell(265,12,'Pending Academic Affairs',0,0,'C');
	  $this->Ln(20);
...
$query=mysqli_query($con,"SELECT * FROM Students where AA_Status=0 AND Finance_Status=1 AND Library_Status=1");
