...
<html>
  ...
  <script type="text/javascript" src="http://canvg.github.io/canvg/canvg.js"></script>
    ...
    <title>ACADEMIC AFFAIRS OFFICE</title>
...
$sql="SELECT * FROM Students WHERE Finance_Status=1 AND AA_Status=0 and Confirm_Status=1";
...
$id=$row['id'];
           ...
           echo"<tr><td>".$row['id']."</td><td>".$row['RegNo']."</td> <td>".$row['Programme']."</td><td>"
			.$row['FullName']."</td><td>".$row['Level']."</td>
			<td><a href='confirm.php? id=".$row['id']."';> Confirm</a></td>
			<td><a onclick='openForm()'><u>missing item</u></a></td>
			</tr>";
...
?>
          ...
          <button class="btn" onclick= "window.location.href= 'print/Confirmed/pdf.php'"><i class="fa fa-download"></i> Download Confirmed</button>
...
<div class="form-popup" id="myForm">
  <form action="disapprove.php" class="form-container" method=GET>
    <h1>Indicate Reason</h1>
    <label for="Fine"><b>Missing Item</b></label>
	<select name="Reason" id='testSelect1' multiple>
    ...
    <!--input type="text" placeholder="Missing Certificate Number" name="Reason" required> -->
