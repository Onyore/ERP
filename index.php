                  ...
                  <form action="verify.php" method="post">
                    <img src="img.png" alt="logo"  style="width:150px;height: 100px; align:center;">
                          <h3 style="text-align:left;font-weight:600;><b>KISII UNIVERSITY</b></h3>
                           ...
                           <h1 class="h4 text-gray-900 mb-4"><u>CERTIFICATE APPLICATION</u></h1>
<?php
                ...
                ?> 
                    ...
                    <div class="form-group">
                      Registration Number:
                      <input type="text" class="form-control form-control-user" name="RegNo" required aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
                      Password:
                      <input type="password" class="form-control form-control-user" name="RegNo" required >
                    </div>
